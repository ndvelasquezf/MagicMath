...
public class Resta {
    ...
    public Resta(int inicio, int fin) {
        this.inicio = inicio;
        this.fin = fin;
    }
    ...
    public void definir(){
        ...
        do{//Minuendo debe ser mayor que sustraendo
        this.factor2 = (int)(this.inicio+Math.round(Math.random()*(this.fin-this.inicio)));
        }while(this.factor1 < this.factor2);
        this.resultado = this.factor1 - this.factor2;
        do{
    ...
    public int getFactor1() {
        //this.factor1 = (this.inicio+rnd.nextInt()*(this.fin-this.inicio));
        //this.factor1 =(int)Math.round(Math.random()*99);
        return factor1;
    }
